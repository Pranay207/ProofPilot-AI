      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-start gap-4">
          <div className="relative">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-sm">
          ...
          <div className="flex-1 min-w-0">
            ...
            {user.merchantId && (
              <div className="mt-1.5 inline-flex items-center gap-1 px-2 py-1 rounded-md bg-slate-100">
        ...
        <div className="flex flex-col gap-2 items-end">
          ...
          <span className="text-xs text-slate-500 font-medium">Merchant Account</span>
        </div>
      </div>
    </div>
  );
